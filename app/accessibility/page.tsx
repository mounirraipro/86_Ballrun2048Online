...
export const metadata: Metadata = {
    ...
    description: 'Ball Run 2048 is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Ball Run 2048 accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Ball Run 2048 accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Ball Run 2048 is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Ball Run 2048 presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Ball Run 2048. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@ballrun2048.online</strong></li>
                </ul>
                <p>
