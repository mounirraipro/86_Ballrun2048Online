...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Ball Run 2048 uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Ball Run 2048 cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Ball Run 2048 uses them, and how you can
                ...
                <p>Ball Run 2048 uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Ball Run 2048.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@ballrun2048.online</strong>.
                </p>
            </div>
        </>
    );
