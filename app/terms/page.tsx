...
export const metadata: Metadata = {
    ...
    description: 'Read the Ball Run 2048 Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Ball Run 2048 terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Ball Run 2048. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Ball Run 2048 at ballrun2048.online, you acknowledge that you have read,
                ...
                <p>
                    Ball Run 2048 provides a free, browser-based game. Ball Run 2048 is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Ball Run 2048 is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Ball Run 2048 — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Ball Run 2048 or its
                ...
                <p>
                    ...
                    Ball Run 2048 for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Ball Run 2048, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Ball Run 2048 a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Ball Run 2048 displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Ball Run 2048 is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Ball Run 2048 and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Ball Run 2048 at our sole
                ...
                <p>
                    ...
                    <strong>legal@ballrun2048.online</strong>.
                </p>
            </div>
        </>
    );
