...
const SUPPORT_EMAIL = 'hello@ballrun2048.online';

export const metadata: Metadata = {
    title: 'Contact Ball Run 2048',
    description: 'Get in touch with the Ball Run 2048 team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Ball Run 2048', 'Ball Run 2048 support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
