...
const SITE_URL = 'https://ballrun2048.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Ball Run 2048',
        url: SITE_URL,
        description: 'Play Ball Run 2048 free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Ball Run 2048 online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
