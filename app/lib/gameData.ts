...
const categorySeed: Array<Omit<GameCategory, 'levels'>> = [
  {
    ...
    longDescription: 'Ballrun2048 Online beginner levels are designed for fast starts, clear goals, and casual sessions.',
  },
  {
    slug: 'classic',
    name: 'Classic',
    ...
    longDescription: 'Ballrun2048 Online classic levels give players a balanced route through the core game experience.',
  },
  {
    slug: 'challenge',
    name: 'Challenge',
    ...
    longDescription: 'Ballrun2048 Online challenge levels are built for players who enjoy tougher decisions and longer sessions.',
  },
  {
    slug: 'expert',
    name: 'Expert',
    ...
    longDescription: 'Ballrun2048 Online expert levels collect the most demanding scenarios for experienced players.',
  },
];
