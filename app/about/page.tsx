...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Ball Run 2048',
        url: 'https://ballrun2048.online/about',
        description: 'Learn about Ball Run 2048, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Ball Run 2048',
...
export const metadata: Metadata = {
    title: 'About Us – Ball Run 2048',
    description: 'Learn about Ball Run 2048, our mission, and the team behind the game.',
    keywords: ['about Ball Run 2048', 'game team', 'who made Ball Run 2048'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Ball Run 2048</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Ball Run 2048 was born from a simple idea: what if playing Ball Run 2048 could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Ball Run 2048 with a clear vision — to create a free, accessible, and
                    ...
                    Ball Run 2048 has something for you.
                </p>
                ...
                <p>
                    Every level in Ball Run 2048 is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Ball Run 2048 offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Ball Run 2048 better for
                    everyone.
                </p>
            </div>
        </>
