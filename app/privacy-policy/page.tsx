...
export const metadata: Metadata = {
    ...
    description: 'Read the Ball Run 2048 Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Ball Run 2048 privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Ball Run 2048, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Ball Run 2048, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Ball Run 2048 is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@ballrun2048.online</strong>.
                </p>
            </div>
        </>
    );
